...
public class _03_VehicleRentalManagementSystem {
    /*
   ...
   static int rentedCount = 0;
    ...
    public static void viewRentedVehicles() {
        ...
        if (rentedCount == 0) {
            ...
            for (int i = 0; i < rentedCount; i++) {
                System.out.println((i+1) + "." + "RentedVehicle: " + rentedVehicles[i]);
            }
        }
    }
    ...
    public static void rentVehicle() {
        ...
        if (vehicleIndex >= 0 && vehicleIndex < vehicleCount) {
            if (vehicleStock[vehicleIndex] > 0) {
                rentedVehicles[rentedCount] = vehicleNames[vehicleIndex];
                rentedCount++;
                vehicleStock[vehicleIndex]--;
                System.out.println("You rent:" + vehicleNames[vehicleIndex]);
            } else {
